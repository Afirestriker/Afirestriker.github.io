...
var Iconify = (function (e) {
    ...
    function c(e, n) {
        ...
        var r = (function (e, n) {
            ...
            return (
                (n || Object.keys(t).concat(Object.keys(r))).forEach(function e(
                    n
                ) {
                    if (t[n]) return (i[n] = []);
                    if (!(n in i)) {
    ...
    function v(e) {
        ...
        for (var r in t) {
            var o = t[r];
            if (!r.match(u) || "string" != typeof o.body || !l(o, i))
                return null;
        }
                ...
                switch (n.type) {
                    case "icons":
                        ...
                        r +=
                            i +
                            ".json?" +
                            new URLSearchParams({ icons: o }).toString();
                        break;
                    case "custom":
                        var a = n.uri;
                            ...
                            setTimeout(function () {
                                ...
                                if (n.length) {
                                    ...
                                    n.forEach(function (n) {
                                        var o = n.icons,
                                            a = o.pending.length;
                                        (o.pending = o.pending.filter(function (
                                            n
                                        ) {
        ...
        n &&
            ...
            (function (e) {
                Ie = Ie.filter(function (n) {
                    return (
                        e !== n &&
                        e !== ("function" == typeof n.node ? n.node() : n.node)
                    );
                });
            })(e));
    }
    ...
    function Ze(e, n, t) {
        ...
        r.innerHTML = c;
        for (
            var u = r.childNodes[0], f = e.attributes, s = 0;
            s < f.length;
            s++
        ) {
            var d = f.item(s),
    ...
    function ln(e, n) {
        ...
        (e ? [e] : Me()).forEach(function (e) {
                ...
                (function (e) {
                    ...
                    return (
                        e
                            ...
                            .forEach(function (e) {
                                var t =
                                    e[Ee] || "svg" !== e.tagName.toLowerCase()
                                        ? Be(e)
                                        : null;
                    ...
                    if (!a) {
                        ...
                        return s
                            ? void c(t, r, s)
                            : ((o = o || "loading" === f),
                              void (t[Ee] = Object.assign({}, r, {
                                  status: f,
                              })));
                    }
                    if (
                        (function (e, n) {
                            if (e.name !== n.name || e.mode !== n.mode)
                                return !0;
                        ...
                        if (!(n = i(r.icon, !1)).icon)
                            return void (a.status = n.status);
                    }
                    c(t, r, n.icon);
                }),
                    e.temporary && !o
            ...
            function c(n, t, i) {
                if (
                    (a || ((a = !0), Re(e)), "SVG" !== n.tagName.toUpperCase())
                ) {
                    var o = t.mode,
                        c =
                            "mask" === o ||
